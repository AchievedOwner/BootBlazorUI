...
namespace BootBlazorUI
{
    ...
    public class Anchor : BootComponentBase, IHasChildContent,IHasTitle
    {
        ...
        /// 设置超链接地址。
        /// </summary>
        [Parameter][ElementTagAttr("href")]public string Link { get; set; }

        /// <summary>
        /// 设置超链接在何处打开链接文档。
        /// </summary>
        [Parameter][ElementTagAttr("target")] public LinkTarget? LinkTarget { get; set; }
        /// <summary>
        /// 设置被下载的超链接目标。
        /// </summary>
        [Parameter][ElementTagAttr] public string Download { get; set; }
        /// <summary>
        /// 设置被链接文档的的 MIME 类型。
        /// </summary>
        [Parameter][ElementTagAttr] public string Type { get; set; }
        /// <summary>
        /// 设置组件在鼠标悬停后显示的标题内容。
        /// </summary>
        [Parameter][ElementTagAttr]public string Title { get; set; }
    }
